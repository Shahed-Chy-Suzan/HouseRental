    ...
    <div class="col-md-5 ml-0 pl-0">
        ...
        <!--------'wishlist' using ajax------->
            <div class="carousel-caption" style="transform: translate(70px,-221px)">
                <button class="addwishlist float-right" data-id="{{ $row->property_id }}" role="button" style="background: none; border-style:none;" title="Add to wishlist">
        ...
        <!---------(Discount equation)-------->
            <div class="carousel-caption" style="transform: translate(-70px,-216px)">
                ...
                <a href="{{ url('property/details/'.$row->property_id) }}" title="Click for details">
