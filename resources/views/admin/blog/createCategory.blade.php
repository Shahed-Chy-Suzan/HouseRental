...
@section('admin_content')
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <h6 class="card-body-title">New Post Category Add </h6>
          <p class="mg-b-20 mg-sm-b-30">New Post Category add form</p>

          <form action="{{ route('store.categoryName') }}" method="post" enctype="multipart/form-data">
          	@csrf
