    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="col-lg-12">
            ...
            <label class="form-control-label">Property Details : <span class="tx-danger">*</span></label>
              <br>
...
//------------------------------------------------------------------------------->
    ...
    @elseif($property->status == 2)
        ...
        <a href="{{ url('admin/property/accept/'.$property->id) }}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp; Send Back to Upload stage</a>
